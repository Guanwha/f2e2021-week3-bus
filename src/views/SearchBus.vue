    ...
    <main class="h-full p-4 bg-dark-800 overflow-auto">
      ...
      <div class="w-full h-full lg:container mx-auto focus:outline-none">
        ...
        <div ref="panel-bus" class="panel panel-display" disabled>
          ...
          <button type="button" class="col-span-1 btn-keyborad" @click="openBusMorePanel()" tabindex="-1">更多</button>
        ...
        <!-- bus-more keyboard -->
        <div ref="panel-bus-more" class="panel panel-display" disabled>
          <button type="button" class="col-span-3 btn-keyborad flex-rcc gap-2 text-light-800" @click="openCityPanel()" tabindex="-1">
            <div class="fill-current">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M12 19.9444C12 19.9444 18.5 15.6111 18.5 10.5555C18.5 8.83164 17.8152 7.17834 16.5962 5.95935C15.3772 4.74036 13.7239 4.05554 12 4.05554C10.2761 4.05554 8.62279 4.74036 7.40381 5.95935C6.18482 7.17834 5.5 8.83164 5.5 10.5555C5.5 15.6111 12 19.9444 12 19.9444ZM14.1674 10.5557C14.1674 11.7523 13.1973 12.7224 12.0007 12.7224C10.8041 12.7224 9.83405 11.7523 9.83405 10.5557C9.83405 9.35908 10.8041 8.38903 12.0007 8.38903C13.1973 8.38903 14.1674 9.35908 14.1674 10.5557Z" fill="currentColor"/>
          ...
          <button type="button" class="col-span-2 btn-keyborad" @click="focusSearchInput()" tabindex="-1">手動輸入</button>
          <button type="button" class="col-span-1 btn-keyborad text-main-500" @click="clickBusKey('F', true)" tabindex="-1">F</button>
          <button type="button" class="col-span-1 btn-keyborad text-main-500" @click="clickBusKey('R', true)" tabindex="-1">R</button>
          <button type="button" class="col-span-1 btn-keyborad text-main-500" @click="clickBusKey('T', true)" tabindex="-1">T</button>
          <button type="button" class="col-span-1 btn-keyborad text-main-500" @click="clickBusKey('快', true)" tabindex="-1">快</button>
          <button type="button" class="col-span-1 btn-keyborad text-main-500" @click="clickBusKey('內科', true)" tabindex="-1">內科</button>
          <button type="button" class="col-span-1 btn-keyborad text-main-500" @click="clickBusKey('跳蛙', true)" tabindex="-1">跳蛙</button>
          <button type="button" class="col-span-1 btn-keyborad text-main-500" @click="clickBusKey('通勤', true)" tabindex="-1">通勤</button>
          <button type="button" class="col-span-1 btn-keyborad text-main-500" @click="clickBusKey('南軟', true)" tabindex="-1">南軟</button>
          <button type="button" class="col-span-1 btn-keyborad text-main-500" @click="clickBusKey('先導', true)" tabindex="-1">先導</button>
          <button type="button" class="col-span-1 btn-keyborad text-main-500" @click="clickBusKey('夜間', true)" tabindex="-1">夜間</button>
          <button type="button" class="col-span-1 btn-keyborad text-main-500" @click="clickBusKey('市民', true)" tabindex="-1">市民</button>
          <button type="button" class="col-span-1 btn-keyborad text-main-500" @click="clickBusKey('其他', true)" tabindex="-1">其他</button>
          <button type="button" class="col-span-3 btn-keyborad flex-rcc text-main-500 fill-current" @click="openBusPanel()" tabindex="-1">
            回上一頁
          </button>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    hideAllPanel() {
      ...
      this.$refs['panel-bus-more'].setAttribute('disabled', '');
    },
    openCityPanel() {
      this.playKeySound();
      this.$refs['panel-bus'].setAttribute('disabled', '');
    ...
    openBusMorePanel() {
      this.$refs['panel-city'].setAttribute('disabled', '');
      this.$refs['panel-bus'].setAttribute('disabled', '');
      this.$refs['panel-bus-more'].removeAttribute('disabled', '');
    },
